...
TEST(Passenger, gettersAndSetters) {
    ...
    // Getters
    Passenger e1 = Passenger("1","Pedro", 20, 'M', "FEUP2021");
...
TEST(Passenger, operators) {
    ...
    Passenger e1 = Passenger("1","Pedro", 20, 'M', "FEUP2021"); passengers.push_back(e1);
    Passenger e2 = Passenger("1","Carlos", 20 , 'm', "ISCTE21"); passengers.push_back(e2);
    Passenger e3 = Passenger("1","Gabriel", 20, 'M', "master21"); passengers.push_back(e3);
    Passenger e4 = Passenger("1","Carolina", 20, 'f', "2points"); passengers.push_back(e4);
    Passenger e5 = Passenger("1","Fabio", 19, 'm', "things1"); passengers.push_back(e5);
